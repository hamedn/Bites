...
(function() {
  angular.module('ionic.rating', []).constant('ratingConfig', {
    ...
    return {
      ...
      template: '<ul class="rating" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon" style="font-size:55px" ng-class="value === undefined ? (r === 1 ? \'ion-ios-star balanced\' : (r === 2 ? \'ion-ios-star-half balanced\' : \'ion-ios-star-outline balanced\')) : (value > $index ? \'ion-ios-star balanced\' : \'ion-ios-star-outline balanced\')"></i></li>' + '</ul>',
      replace: true,
